...
#include "jd-sync/common/Message.h"

#include <QMetaMethod>

class BaseSyncableList : public QObject, public AbstractActor
{
	Q_OBJECT
	Q_FLAGS(Flag Flags)
public:
	...
	explicit BaseSyncableList(MessageHub *hub, const QString &channel, const QString &cmdPrefix, const QString &indexProperty, const Flags &flags = AllFlags, QObject *parent = nullptr);

	virtual void set(const int index, const QString &property, const QVariant &value, const Message &origin = Message()) = 0;
	void set(const QVariant &index, const QString &property, const QVariant &value, const Message &origin = Message());
	...
	virtual void add(const QMap<QString, QVariant> &values, const Message &origin = Message()) = 0;
	void add(const QVariant &index, const QMap<QString, QVariant> &values, const Message &origin = Message());
	virtual void remove(const int index, const Message &origin = Message()) = 0;
	void remove(const QVariant &index, const Message &origin = Message());
...
protected:
	...
	virtual void receive(const Message &msg) override;
...
class SyncableList : public BaseSyncableList
{
	Q_OBJECT
public:
	explicit SyncableList(MessageHub *hub, const QString &channel, const QString &cmdPrefix, const QString &indexProperty, const Flags &flags = AllFlags, QObject *parent = nullptr);

	void set(const int index, const QString &property, const QVariant &value, const Message &origin) override;
	QVariant get(const int index, const QString &property) const override;
	QVariantMap getAll(const int index) const override;
	void add(const QMap<QString, QVariant> &values, const Message &origin = Message()) override;
	void remove(const int index, const Message &origin = Message()) override;
...
class SyncableQObjectList : public BaseSyncableList
{
	Q_OBJECT
public:
	explicit SyncableQObjectList(MessageHub *hub, const QString &channel, const QString &cmdPrefix, const QString &indexProperty, const Flags &flags = AllFlags, QObject *parent = nullptr);
...
private:
	...
	void add(const QMap<QString, QVariant> &values, const Message &origin) override;
